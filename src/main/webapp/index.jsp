                                ...
                                <% if (listarPerros!=null){ %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger" data-elimniar="<%= perro.getNombre()%>" id="eliminar">
                                                 ...
                                                 <a href="SvEliminar?nombre=<%= perro.getNombre() %>" class="btn btn-warning" data-editar="<%= perro.getNombre()%>" id="editar">
